"""
Django settings for TeamLoom project.
"""
import os
...
WSGI_APPLICATION = 'teamloom.wsgi.application'
ASGI_APPLICATION = 'teamloom.asgi.application'

# Database
# Use DATABASE_URL in production (Render), SQLite for development
import sys
if os.environ.get('DATABASE_URL'):
...
elif 'test' in sys.argv or os.environ.get('USE_SQLITE', 'true').lower() == 'true':
    DATABASES = {
        'default': {
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': os.environ.get('DB_NAME', 'teamloom'),
            'USER': os.environ.get('DB_USER', 'teamloom'),
            'PASSWORD': os.environ.get('DB_PASSWORD', 'teamloom_secret'),
...
# Caches - use local memory cache for development
if os.environ.get('USE_REDIS', 'false').lower() == 'true':
    CACHES = {
        'default': {
